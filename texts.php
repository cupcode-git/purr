<?php
  ...
  /*=================================================================
    ...
    $anuncios = "anúncios";
    $adapseo = "adaptação SEO";
    $criacao = "criação";
    $editorial = "editorial";
    $criacontedit = "criação de conteúdo editorial";
    $portfolio = "portfólio";
    $todos = "todos";
    ...
    $otimizacaodeconteudo = "otimização de conteúdo";
    $seo = "seo";
    $indicadordedesempenho = "indicador de desempenho";
    $kpi = "kpi";
