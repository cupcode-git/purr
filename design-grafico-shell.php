<section class="no-padding wow hero-grafico fadeIn no-transition">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="intro-text center lightcolor1 wow fadeInUp">
                <h2 class="bottom45 ccdeep"><?php echo $branding; ?></h2>
                <p class="bottom15 mobilespc"><?php echo $descricao_txt_branding; ?></p>
            </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-md-8 col-sm-10">
                <div class="intro-text center wow fadeInUp">
                    <h2 class="bottom45 ccdeep"><?php echo $papelaria ?></h2>
                    <p class="bottom45 mobilespc"><?php echo $descricao_txt_papelaria; ?></p>
                </div>
            </div>
        </div>
    </div>
