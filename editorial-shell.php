<section class="no-padding wow hero-editorial fadeIn no-transition">
         ...
         <ul>	<!-- slide -->
               <li data-index="rs-layers" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="500"  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                  ...
                  <div class="tp-caption tp-resizeme"
                        ...
                        data-paddingright="[0,0,0,0]"
                        data-paddingbottom="[0,0,0,0]"
                        data-paddingleft="[0,0,0,0]" style="z-index: 19;"><h2 class="darkcolor"><?php echo $artigos; ?></h2></div>
                  <!-- layer nr. 11 -->
                  <div class="tp-caption tp-resizeme"
                        id="layers-nine"
                        data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']"
                        ...
                        data-paddingright="[0,0,0,0]"
                        data-paddingbottom="[0,0,0,0]"
                        data-paddingleft="[0,0,0,0]" style="z-index: 19;"><h2 class="darkcolor"><?php echo $materias; ?></h2></div>
                  <!-- layer nr. 12 -->
                  <div class="tp-caption tp-resizeme"
                        id="layers-ten"
                        data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']"
      ...
      <div class="row">
         <div class="col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2">
            <div class="item-titles whitecolor text-center wow fadeInLeft">
               <h1 class="bottom25 ccdeep"><?php echo $descricao_titulo_editorial; ?></h1>
            </div>
         </div>
      ...
      <div class="row">
         ...
         <div class="col-md-8 col-sm-10">
            <div class="intro-text center lightcolor1 wow fadeInUp">
               <h2 class="bottom45 ccdeep"><?php echo $editorial; ?></h2>
               <p class="bottom15 mobilespc"><?php echo $descricao_txt_editorial; ?></p>
            </div>
         </div>
      </div>
   </div>
         ...
         <div class="row">
            <div class="col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2">
               <div class="intro-text center wow fadeInUp">
                  <h2 class="bottom25 ccdeep"><?php echo $pacote; ?></h2>
               </div>
            </div>
            <div class="col-md-2 col-sm-2"></div>
         </div>
