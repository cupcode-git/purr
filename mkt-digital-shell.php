	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-8 col-sm-10">
				...
				<h2 class="bottom45 ccdeep"><?php echo $redessociais; ?></h2>
				<p class="bottom45 mobilespc"><?php echo $descricaotxtredessociais; ?></p>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="container-fluid container-padding">
		<div class="row">
			<div class="col-md-6 col-sm-9 text-left wow fadeInRight">
				...
				<h2 class="bottom45 ccdeep"><?php echo $gerenciamento; ?></h2>
				<p><?php echo $descricaotxtgerenciamento; ?></p>
	...
	<div class="container-fluid container-padding">
		...
		<div class="col-md-6 col-sm-3"></div>
			<div class="col-md-6 col-sm-9 text-right wow fadeInRight">
				<div class="item-titles wow fadeInLeft">
				<h2 class="bottom45 ccdeep"><?php echo $post; ?></h2>
				<p><?php echo $descricaotxtpost; ?></p>
	...
	<div class="container-fluid">
		<div class="row box-info-wrap">
			<div class="col-md-6 col-sm-6 nopadding">
				...
				<div class="item-titles wow fadeInLeft">
				<span class="heading-title bottom25"><?php echo $anuncios; ?></span>
					<h2 class="bottom45 ccdeep"><?php echo $googleads; ?></h2>
					<p><?php echo $descricaotxtgoogleads; ?></p>
				</div>
				</div>
			</div>
			<div class="col-md-6 col-sm-6 nopadding">
			...
			<div class="col-md-6 col-sm-6 nopadding">
				...
				<div class="item-titles wow fadeInLeft">
					<span class="heading-title bottom25"><?php echo $anuncios; ?></span>
					<h2 class="bottom45 ccdeep"><?php echo $facebookads; ?></h2>
					<p><?php echo $descricaotxtfacebookads; ?></p>
				</div>
				</div>
			</div>
		</div>
	...
	<div class="container-fluid">
		<div class="row box-info-wrap">
			<div class="col-md-6 col-sm-6 nopadding">
				<div class="box-info container-padding padding_half1 equalheight">
				<div class="item-titles wow fadeInLeft">
					<span class="heading-title bottom25"><?php echo $otimizacaodeconteudo; ?></span>
					<h2 class="bottom45 ccdeep"><?php echo $seo; ?></h2>
					<p><?php echo $descricaotxtseo; ?></p>
				</div>
				</div>
			</div>
			<div class="col-md-6 col-sm-6 nopadding">
			...
			<div class="col-md-6 col-sm-6 nopadding">
				<div class="box-info container-padding padding_half1 equalheight">
				<div class="item-titles wow fadeInLeft">
				<span class="heading-title bottom25"><?php echo $indicadordedesempenho; ?></span>
					<h2 class="bottom45 ccdeep"><?php echo $kpi; ?></h2>
					<p><?php echo $descricaotxtkpi; ?></p>
				</div>
				</div>
			</div>
		</div>
	...
	<div class="container-fluid">
		<div class="row box-info-wrap">
			<div class="col-md-6 col-sm-6 nopadding">
				<div class="box-info container-padding padding_half1 equalheight">
				<div class="item-titles wow fadeInLeft">
					<span class="heading-title bottom25"><?php echo $maladireta; ?></span>
					<h2 class="bottom45 ccdeep"><?php echo $emailmarketing; ?></h2>
					<p><?php echo $descricaotxtemailmarketing; ?></p>
				</div>
				</div>
			</div>
			<div class="col-md-6 col-sm-6 nopadding">
